...
## ⚗ Nobel Atlas — Ultralearn Chemistry

An interactive study lab for learning chemistry through **every Nobel Prize in Chemistry (1901–2025)**.
...
**Run it:** clone the repo and open `index.html` in a browser — it's a fully static, offline app. Your notes and flashcards are saved in your browser (Export/Import to back up or move them).

Data is built from `data/part*.json` (sourced from nobelprize.org) via `python3 build_data.py`.
