...
data=r('data/prizes.js'); store=r('src/store.js'); graph=r('src/graph.js'); app=r('src/app.js')
html=html.replace('<link rel="stylesheet" href="src/styles.css" />', '<style>\n'+css+'\n</style>')
for tag in ['<script src="data/prizes.js"></script>','<script src="src/store.js"></script>',
